...
public class AtividadeController {
    ...
    public ResponseEntity<?> criar(@RequestBody NovaAtividadeDTO dto) {
        try {
    ...
    public ResponseEntity<?> buscarPorToken(@PathVariable String tokenProtocolo) {
        try {
            return applicationService.buscarPorToken(tokenProtocolo)
                .map(atividade -> ResponseEntity.ok((Object) Map.of(
    ...
    public ResponseEntity<?> avaliar(@PathVariable Long id, @RequestBody AvaliacaoAtividadeDTO dto) {
        try {
